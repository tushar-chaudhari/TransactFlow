package com.nitk.OrderService.command.api.saga;

import com.nitk.CommonService.commands.*;
import com.nitk.CommonService.events.*;
...
public class OrderProcessingSaga {
    ...
    private void handle(OrderCreatedEventNew event) {
        ...
        try {
//            if(true)
//                throw new Exception("Exception Occured in Create order command");
